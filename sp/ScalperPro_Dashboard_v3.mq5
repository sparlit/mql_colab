...
void Draw()
{
   ...
   //=== HEADER ===
   int hx=PX+5, hy=PY+4;
   DrawL("HDR",hx,hy,"SCALPER PRO - "+sym+" | "+EnumToString((ENUM_TIMEFRAMES)Period())+" | "+d.vm,InpHdr,12,true);
   hy+=LH;
...
void DrawC(string id,int x,int y,int w,string t)
{
   ...
   ObjectSetInteger(0,n,OBJPROP_YSIZE,LH*6+CP*2);
...
void CreatePanel(int tw)
{
   ...
   ObjectSetInteger(0,n,OBJPROP_YSIZE,550);
